...
import static com.example.woltandroid.utils.Constants.CREATE_ORDER;
import static com.example.woltandroid.utils.Constants.GET_RESTAURANT_MENU;
...
import com.example.woltandroid.model.Cuisine;
...
public class MenuActivity extends AppCompatActivity implements MenuAdapter.OnQuantityChangeListener {
    ...
    private void loadMenu() {
        ...
        System.out.println("MenuActivity restaurantId = " + restaurantId);
        System.out.println("URL = " + GET_RESTAURANT_MENU + restaurantId);
                ...
                handler.post(() -> {
                    try {
                        if (!response.equals("Error")) {
                            ...
                            gsonBuilder.registerTypeAdapter(LocalDateTime.class, new LocalTimeSerializer());
